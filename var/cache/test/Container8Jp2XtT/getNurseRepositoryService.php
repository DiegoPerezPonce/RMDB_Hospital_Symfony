 ...
 */
class getNurseRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\NurseRepository' shared autowired service.
     *
     * @return \App\Repository\NurseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NurseRepository.php';

        return $container->privates['App\\Repository\\NurseRepository'] = new \App\Repository\NurseRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
